    ...
    <section id="milestones" className="section-padding bg-white">
      <div className="container-custom">
        ...
        <div className="mt-12 space-y-6 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-x-hidden">
          ...
          <div className="relative overflow-hidden">
            <div className="flex animate-marquee-r will-change-transform" style={{ ['--mobile-speed' as any]: '10s', ['--desktop-speed' as any]: '45s' }} data-mobile-speed="45s" data-desktop-speed="45s">
                            {[0, 1].map((dup) => (
