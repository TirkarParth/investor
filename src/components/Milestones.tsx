      ...
      <div className="container-custom">
        ...
        {selectedMilestone && (
          <div className="mb-16">
            <div className="flex flex-col lg:flex-row rounded-2xl shadow-xl overflow-hidden transition-all duration-500 max-w-4xl mx-auto">
              {/* Left side - Logo area */}
              <div className={`p-4 lg:p-6 flex flex-col items-center justify-center w-full lg:w-64 h-48 lg:h-auto min-h-[250px] ${
                (() => {
                ...
                {milestones.find(m => m.key === selectedMilestone)?.url && (
                  <div className="pt-4 space-y-2 flex flex-col items-center lg:items-start">
                    ...
                    {selectedMilestone === 'nativeapp' && (
                      <div className="flex flex-col lg:flex-row space-y-3 lg:space-y-0 lg:space-x-4 w-full lg:w-auto">
        ...
        <div className="mt-12 space-y-6 w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] overflow-x-hidden">
          ...
          <div className="relative overflow-hidden">
            <div className="flex animate-marquee-l will-change-transform" style={{ ['--mobile-speed' as any]: '15s', ['--desktop-speed' as any]: '45s' }} data-mobile-speed="10s" data-desktop-speed="45s">
                                          {[0, 1].map((dup) => (
          ...
          <div className="relative overflow-hidden">
            <div className="flex animate-marquee-r will-change-transform" style={{ ['--mobile-speed' as any]: '15s', ['--desktop-speed' as any]: '45s' }} data-mobile-speed="45s" data-desktop-speed="45s">
                            {[0, 1].map((dup) => (
        ...
        <div className="hidden lg:block mt-16 text-center">
          ...
          <div className="flex flex-col lg:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-8 py-4 bg-black text-white rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 font-semibold"
            >
              <svg className="w-7 h-7 mr-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
              </svg>
              <div className="text-left">
                <div className="text-sm opacity-80">{t('traction.companyMilestones.nowFor')}</div>
                <div className="text-base font-bold">Apple</div>
              </div>
            </a>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-sm opacity-80">{t('traction.companyMilestones.nowFor')}</div>
                <div className="text-base font-bold">Chrome</div>
              </div>
            </a>
          </div>
        </div>
